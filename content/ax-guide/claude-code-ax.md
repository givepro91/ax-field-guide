...
slides:
  ...
  - kick: 테제
    title: 쓰기보다 운영이다
    body: "잘 쓴다는 건 좋은 프롬프트가 아니라, 무엇을 위임하고 어디서 멈춰 검증받게 할지를 정하는 일."
  - kick: 신호
    title: 도구 위에 도구를 만든다
    body: 설정 동기화·워크플로우 키트·산출물 관리 — 그냥 쓰는 게 아니라 운영하기 시작하면 생기는 것들.
  - kick: 경계
  ...
  - kick: 게이트
    ...
    body: 자동 적용할지 제안받고 승인할지. 빌드·테스트·사람 중 무엇으로 검증할지.
  - kick: 정리
    title: 운영 구조가 결과를 가른다
